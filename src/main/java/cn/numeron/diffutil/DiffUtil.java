...
public class DiffUtil {
     ...
     */
    @NotNull
    public static DiffResult calculateDiff(@NotNull Callback cb) {
     ...
     */
    @NotNull
    public static DiffResult calculateDiff(@NotNull Callback cb, boolean detectMoves) {
    ...
    public static class DiffResult {
        ...
        private void findMatchingAddition(int posX) {
            int posY = 0;
            for (final Diagonal diagonal : mDiagonals) {
         ...
         */
        public void dispatchUpdatesTo(@NotNull ListUpdateCallback updateCallback) {
    ...
    static class BatchingListUpdateCallback implements ListUpdateCallback {
        ...
        public BatchingListUpdateCallback(@NotNull ListUpdateCallback callback) {
            mWrapped = callback;
        }
